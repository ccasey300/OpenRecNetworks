...
def assignmentTopo():
    ...
    os.system('sudo ovs-vsctl set port s1-eth2 qos=@newqos -- --id=@newqos create qos type=linux-htb queues=0=@q0,1=@q1 -- --id=@q0 create queue other-config:min-rate=20000000 other-config:max-rate=1000000000000 --  --id=@q1 create queue other-config:min-rate=50000000 other-config:max-rate=150000000')
    ...
    os.system('sudo ovs-vsctl set port s1-eth4 qos=@newqos -- --id=@newqos create qos type=linux-htb queues=0=@q0,1=@q1 -- --id=@q0 create queue other-config:min-rate=20000000 other-config:max-rate=1000000000000 --  --id=@q1 create queue other-config:min-rate=50000000 other-config:max-rate=200000000')
